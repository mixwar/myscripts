...
local Services = {
    ...
    RunService = game:GetService("RunService"),-- [Services] -----------------------------------------------------------------------------------------------------------------------------------------------------------------
local Services = {
    Workspace = game:GetService("Workspace"),
    Players = game:GetService("Players"),
    LocalPlayer = game:GetService("Players").LocalPlayer,
    UserInput = game:GetService("UserInputService"),
    Camera = game:GetService("Workspace").CurrentCamera,-- [Services] -----------------------------------------------------------------------------------------------------------------------------------------------------------------
local Services = {
    Workspace = game:GetService("Workspace"),
    Players = game:GetService("Players"),
    LocalPlayer = game:GetService("Players").LocalPlayer,
...
local library = {
	...
	draggable = true,
	flags = {},
	title = "Universal Aimbot By Albara#9123 1.0v",
	open = false,
